...
const FeaturesCarousel = ({ options, data, className }) => {
  const classes = classNames(
    `w-3/12 flex flex-col h-full gap-[10px] justify-end items-center rounded bg-white shadow-lg shadow-[#17171720] p-5 transition-all hover:bg-[#171717] hover:text-white`
  );
